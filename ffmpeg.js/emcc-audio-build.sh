...
emcc --memory-init-file 0 -O2 -s WASM=0 -s TOTAL_MEMORY=67108864 dist/ffmpeg.bc dist/libmp3lame.bc dist/libvorbis.bc dist/libvorbisenc.bc dist/libogg.bc dist/libfdk-aac.bc -o dist/ffmpeg.js --pre-js ffmpeg_pre.js --post-js ffmpeg_post.js
cp dist/ffmpeg.js ../js
